...
HD_PWD='/home/it/DigitalSystemDesign/Lab7/even_odd_detector/even_odd_detector.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log even_odd_detector_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source even_odd_detector_top.tcl
